-- ============================================================
--  SHINOBI NO SEKAI — Migration SQL
...
CREATE TABLE IF NOT EXISTS characters (
  ...
  clan            VARCHAR(100),
  village         VARCHAR(100),
  rank            VARCHAR(20) DEFAULT 'Acadêmico'
  ...
  -- STATUS
  hp_current      INT DEFAULT 20,
  hp_max          INT DEFAULT 20,
  chakra_current  INT DEFAULT 10,
  chakra_max      INT DEFAULT 10,
  stress          INT DEFAULT 0 CHECK (stress BETWEEN 0 AND 100),

  -- ATRIBUTOS (total 8, máx 4 por atributo)
  ...
  -- PERÍCIAS (total 6, máx 3 por perícia)
...
-- ============================================================
-- CRIAR USUÁRIO MESTRE (GM)
-- ============================================================
INSERT INTO users (username, password_hash, discord_id, discord_username, role)
VALUES (
  'mestre',
  '$2a$10$rFWfiPscOTveOJGN1mWBRO7M102MfA2JMY3gFcaadC1qICaYKD6V2',
  '000000000000000001',
  'mestre',
  'gm'
...
-- Login: mestre / Senha: 03QE4G41%Z5?!m?Pc
-- ============================================================
